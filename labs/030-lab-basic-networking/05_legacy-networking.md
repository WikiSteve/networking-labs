...
![Contents of /etc/network/interfaces before converting the legacy configuration from DHCP to static.](assets/images/file-62d0338a165da.png)
...
![Edited /etc/network/interfaces showing ens32 configured with a static IPv4 address.](assets/images/file-62d0362946ba0.png)
...
![Contents of /etc/resolv.conf updated manually with the correct nameserver for the static configuration.](assets/images/file-62d037110dd5b.png)

![Follow-up view of /etc/resolv.conf confirming the static nameserver entry after editing.](assets/images/file-62d037f91503f.png)
...
![Terminal and packet-capture proof showing that SSH traffic still works after the legacy static configuration is applied.](assets/images/file-62d03a728b007.png)
