...
![Virtual Machine Settings with the network adapter set to bridged mode for the net-tools section.](assets/images/file-62d00275d704f.png)

Open the **Virtual Network Editor** by going edit > Virtual Network Editor in Workstation.

![VMware Virtual Network Editor showing the available virtual networks and connection types.](assets/images/file-62d0031cd0b6e.png)
...
![Terminal showing ifconfig is not installed by default on the Debian system.](assets/images/file-62d0087fab73e.png)
...
![Terminal reading the ARP cache stale time from /proc for the active interface.](assets/images/file-62d009bd4c6dd.png)

Once a whole minute or two goes by, run **`sudo arp -a`**. It should be blank!

![Terminal showing an empty ARP cache after the interface is down long enough for entries to age out.](assets/images/file-62d00a3062819.png)
...
![Ping to google.ca in bridged mode showing duplicate replies on a system affected by MAC cloning limitations.](assets/images/file-62d00e659d777.png)

Because your ARP cache is aging, run **`sudo arp -a`** quick like a bunny.

![ARP cache entry captured immediately after the ping, showing the neighbor IP and MAC address.](assets/images/file-62d00f28e3132.png)
...
![Spreadsheet example populated with an IP address, MAC address, vendor, network, and description from the bridged network.](assets/images/file-62d0133673d74.png)
...
![Legacy route command output displaying the kernel routing table on the bridged network.](assets/images/file-62d0148fce1c1.png)
...
![Contents of /etc/resolv.conf showing the resolver search domain and nameserver.](assets/images/file-62d0166fd5b85.png)
...
![dhclient output while the interface is brought down to inspect DHCP lease behavior.](assets/images/file-62d01825c639c.png)
...
![Traceroute to google.ca showing the first hops discovered from the bridged network.](assets/images/file-62d01b36e19c3.png)
...
![Spreadsheet example updated with the inside and outside routers learned from traceroute.](assets/images/file-62d01cce6ff6c.png)
...
![ifconfig output after assigning a static IPv4 address to ens32 with net-tools.](assets/images/file-62d01de8f3498.png)
