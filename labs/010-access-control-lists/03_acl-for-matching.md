...
![Image](assets/images/file-67451301aed6e.png)

![Image](assets/images/file-674514283f70f.png)
...
![Image](assets/images/file-6745e11d24eb8.png)
...
![Image](assets/images/file-6745e3c9df9c3.png)

## **Screenshot 8 Testing VLAN 42 IPv4 Connectivity**

![Image](assets/images/file-6745e5cdf2e95.png)
...
**Hostname:** Must follow the format:
 ...
 Example: If your name is John Smith, the hostname must be:
...
**Prompt:** The shell prompt must include:
  ...
  - **Date and Time**, formatted as shown in the example:
